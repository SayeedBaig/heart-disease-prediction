      ...
      <div className="cardio-container flex items-center justify-between gap-3 py-2.5">
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          {!isHome && (
            <button
              onClick={handleBack}
              className="btn-secondary px-3 py-1.5 text-xs font-medium rounded-full flex items-center gap-1.5 shrink-0"
              title="Go back"
            >
              <ArrowLeft size={14} />
          ...
          <Link to="/" className="flex shrink-0 items-center gap-2 sm:gap-2.5 group">
            <div className="w-8 h-8 rounded-xl bg-[var(--accent-primary)] text-white flex items-center justify-center shadow transition-all group-hover:shadow-md group-hover:scale-105">
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-3">
          <nav className="hidden lg:flex items-center gap-5 text-xs font-medium text-[var(--text-secondary)]">
            <Link to="/" className="transition-colors hover:text-[var(--accent-primary)]">
              Home
            </Link>
          </nav>
          ...
          <button
            onClick={toggleTheme}
            className="w-8 h-8 rounded-full border border-[var(--border-color)] bg-[var(--card-bg)] text-[var(--text-secondary)] hover:bg-[var(--bg-secondary)] hover:border-[var(--accent-primary-border)] transition-all flex items-center justify-center"
