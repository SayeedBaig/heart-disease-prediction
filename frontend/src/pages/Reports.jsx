  ...
  return (
    <div className="cardio-shell">
      ...
      <main className="cardio-container py-8 flex-1 w-full max-w-5xl">
        ...
        <div className="no-print flex flex-col sm:flex-row items-start sm:items-center justify-between pb-6 mb-8 border-b border-[var(--border-color)] gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className={`text-xs py-2.5 px-4 rounded-full flex items-center gap-2 transition-all ${
                emailSent
        ...
        <div className="cardio-card p-8 space-y-8 bg-white dark:bg-[#1A1A1E] rounded-[28px]">
          {/* Header */}
          <div className="flex justify-between items-start border-b border-[var(--border-color)] pb-6">
            <div>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-lg bg-[var(--accent-primary)] text-white flex items-center justify-center font-bold text-sm">
                  AI
                </div>
          ...
          <div>
            <h3 className="section-title text-xs font-bold uppercase tracking-wider text-[var(--accent-primary)] mb-3 flex items-center gap-2">
              <User size={16} />
              1. Patient Details
            </h3>
          ...
          <div>
            ...
            <div className="p-5 rounded-xl border border-[var(--border-color)] flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-2xl bg-[var(--accent-primary-light)] border border-[var(--accent-primary-border)] text-[var(--accent-primary)] flex items-center justify-center font-extrabold text-2xl">
                  {riskPct}%
                </div>
                <div>
