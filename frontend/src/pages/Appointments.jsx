      ...
      <main className="cardio-container py-8 flex-1 w-full max-w-5xl">
        ...
        {step <= 4 && (
          <div className="flex items-center justify-between mb-8 text-xs font-medium border-b border-[var(--border-color)] pb-4">
            <div className={`flex items-center gap-2 ${step >= 1 ? "text-[var(--accent-primary)] font-bold" : "text-[var(--text-muted)]"}`}>
              <span className="w-5 h-5 rounded-full bg-[var(--accent-primary-light)] flex items-center justify-center text-[10px]">1</span>
              1. Choose Doctor
            </div>
            <div className={`flex items-center gap-2 ${step >= 2 ? "text-[var(--accent-primary)] font-bold" : "text-[var(--text-muted)]"}`}>
              <span className="w-5 h-5 rounded-full bg-[var(--accent-primary-light)] flex items-center justify-center text-[10px]">2</span>
              2. Select Date
            </div>
            <div className={`flex items-center gap-2 ${step >= 3 ? "text-[var(--accent-primary)] font-bold" : "text-[var(--text-muted)]"}`}>
              <span className="w-5 h-5 rounded-full bg-[var(--accent-primary-light)] flex items-center justify-center text-[10px]">3</span>
              3. Select Time
            </div>
            <div className={`flex items-center gap-2 ${step >= 4 ? "text-[var(--accent-primary)] font-bold" : "text-[var(--text-muted)]"}`}>
              <span className="w-5 h-5 rounded-full bg-[var(--accent-primary-light)] flex items-center justify-center text-[10px]">4</span>
              4. Submit
            </div>
          </div>
        )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {doctors.map((doc) => (
                  <div
                    ...
                    className="cardio-card-interactive p-5 rounded-[28px] flex flex-col justify-between group"
                  >
                    <div>
                      ...
                      <p className="caption-small text-[var(--accent-primary)] font-medium mt-0.5">
                        {doc.specialization}
                      </p>
                    ...
                    <button className="btn-primary text-xs py-2 px-3 mt-4 w-full rounded-full flex items-center justify-center gap-1">
        ...
        {/* STEP 2: SELECT DATE */}
        {step === 2 && (
          <div className="cardio-card rounded-[28px] p-6 space-y-6 max-w-xl mx-auto">
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-[var(--border-color)]">
              <button onClick={() => setStep(1)} className="btn-secondary text-xs py-2 px-4 rounded-full">
                Back
              </button>
              <button
                disabled={!form.date}
                onClick={() => setStep(3)}
                className="btn-primary text-xs py-2 px-5 rounded-full disabled:opacity-50"
              >
                Next: Select Time
              </button>
            </div>
        ...
        {step === 3 && (
          <div className="cardio-card rounded-[28px] p-6 space-y-6 max-w-xl mx-auto">
                  ...
                  <button
                    ...
                    className={`py-2.5 px-3 rounded-xl border text-xs font-semibold transition-all ${
                      form.time === t
                        ...
                        : "bg-[var(--input-bg)] text-[var(--text-primary)] border-[var(--input-border)] hover:border-[var(--accent-primary-border)]"
                    }`}
                  >
                    {t}
                  </button>
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-[var(--border-color)]">
              <button onClick={() => setStep(2)} className="btn-secondary text-xs py-2 px-4 rounded-full">
                Back
              </button>
              <button
                onClick={() => setStep(4)}
        ...
        {step === 4 && (
          <div className="cardio-card rounded-[28px] p-6 space-y-6 max-w-xl mx-auto">
            ...
            <div className="p-4 rounded-2xl bg-[var(--bg-secondary)] space-y-2 text-xs">
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-[var(--border-color)]">
              <button onClick={() => setStep(3)} className="btn-secondary text-xs py-2 px-4 rounded-full">
                Back
              </button>
              <button
        ...
        {step === 5 && (
          <div className="cardio-card rounded-[28px] p-8 text-center max-w-lg mx-auto space-y-4">
