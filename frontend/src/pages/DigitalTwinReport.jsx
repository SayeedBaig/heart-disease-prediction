...
export default function DigitalTwinReport({ onBack }) {
    ...
    return (
      <div className="cardio-shell">
        ...
        <main className="cardio-container flex flex-1 items-center justify-center py-20">
          <div className="cardio-card max-w-md p-8 text-center space-y-4 rounded-[28px]">
            <div className="w-14 h-14 rounded-2xl bg-[var(--accent-primary-light)] text-[var(--accent-primary)] flex items-center justify-center mx-auto">
              <FileText size={28} />
            </div>
  ...
  return (
    <div className="cardio-shell">
      ...
      <main className="cardio-container w-full max-w-5xl flex-1 py-10 space-y-8">
        ...
        <div className="no-print flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-6 border-b border-[var(--border-color)]">
          <div>
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-[var(--accent-primary)] text-white flex items-center justify-center">
                <Activity size={18} />
              </div>
          ...
          <div className="flex items-center gap-3 no-print">
            <button
              ...
              className="btn-secondary text-xs py-2.5 px-4 rounded-full flex items-center gap-2"
            >
              <Sparkles size={14} />
        ...
        {showSummary && (
          <div className="no-print cardio-card p-6 border border-[var(--accent-primary-border)] bg-[var(--accent-primary-light)] space-y-2">
            <h3 className="text-xs font-bold uppercase tracking-wider text-[var(--accent-primary)] flex items-center gap-2">
              <Sparkles size={14} />
        ...
        {/* Risk Banner */}
        <div className="cardio-card p-8 md:p-10 bg-gradient-to-r from-[var(--accent-primary)] via-[#1a3aa8] to-[var(--accent-primary)] text-white rounded-[28px] shadow-md border-0">
          <h2 className="caption-small text-white/80 uppercase font-bold tracking-wider mb-8 flex items-center gap-2">
            <HeartPulse size={16} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <div className="text-3xl md:text-4xl font-extrabold mt-3 text-white">
            ...
            <div>
              ...
              <div className="text-xl md:text-2xl font-bold mt-3 text-white flex items-center gap-2">
        ...
        {/* Patient Credentials */}
        <div className="cardio-card p-7 md:p-8 space-y-5">
          <h3 className="text-xs font-bold uppercase tracking-wider text-[var(--accent-primary)] flex items-center gap-2">
            <User size={15} />
            Patient Credentials
          </h3>
          ...
          <dl className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {[
              { label: "Patient ID", value: report.patient?.id ?? "N/A" },
              { label: "Full Name", value: report.patient?.name ?? "N/A" },
              {
                label: "Generated",
              ...
              <div
                key={label}
                className="p-5 rounded-xl bg-[var(--bg-secondary)] text-xs space-y-1.5"
              >
        ...
        <div className="cardio-card p-7 md:p-8 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {(report.metrics ?? []).map(([label, value]) => (
              <div
                key={label}
                className="flex items-center justify-between p-4 rounded-xl border border-[var(--border-color)] bg-[var(--card-bg)] text-xs"
              >
        ...
        <div className="cardio-card p-7 md:p-8 space-y-5">
          ...
          {report.summary && (
            <div className="p-5 mb-2 rounded-xl bg-[var(--bg-secondary)] text-xs leading-relaxed text-[var(--text-secondary)]">
              {report.summary}
            </div>
          )}
          ...
          <ul className="space-y-4 mt-2">
            {(report.recommendations ?? []).map((item, idx) => (
              <li
                key={idx}
                className="flex items-start gap-3 p-5 rounded-xl border border-[var(--accent-primary-border)] bg-[var(--accent-primary-light)] text-xs text-[var(--text-primary)] font-medium"
              >
                <CheckCircle2 size={15} className="text-[var(--accent-primary)] shrink-0 mt-0.5" />
                <span>{item}</span>
              </li>
            ))}
          </ul>
        ...
        {/* Footer */}
        <div className="cardio-card p-6 flex items-center justify-between text-xs text-[var(--text-muted)]">
          <div className="flex items-center gap-2">
            <Calendar size={14} />
            <span>
          ...
          <div className="italic text-right hidden sm:block">
            CardioAI Intelligence Engine &middot; Confidential Medical Decision Support
          </div>
        </div>
