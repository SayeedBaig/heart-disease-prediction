...
export default function PatientPortal() {
  ...
  /* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ SCREEN RENDERING â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  if (screen === "profile") {
    ...
    return (
      <div className="cardio-shell relative overflow-hidden">
        ...
        />
        <main className="relative z-10 cardio-container w-full max-w-4xl flex-1 py-10">
          <div className="mb-8 border-b border-[var(--border-color)] pb-6">
            <span className="caption-small font-bold uppercase tracking-wider text-[var(--accent-primary)]">Patient Workspace</span>
          ...
          <div className="cardio-card p-0 overflow-hidden rounded-2xl">
            <div className="p-6 border-b border-[var(--border-color)]">
              <p className="caption-small font-semibold uppercase tracking-wide">Patient</p>
              <h2 className="mt-1.5 text-sm font-semibold text-[var(--text-primary)]">{patient.full_name || patient.name || "Patient"}</h2>
            </div>
            <dl className="grid divide-y divide-[var(--border-color)] sm:grid-cols-2 sm:divide-x sm:divide-y-0">
              {details.map(([label, value]) => (
                <div key={label} className="p-6">
                  ...
                  <dd className="mt-1.5 break-words text-sm font-semibold text-[var(--text-primary)]">{String(value)}</dd>
                </div>
              ))}
            </dl>
          </div>
        ...
        <main className="cardio-container py-8 flex-1 w-full max-w-4xl">
          <div className="cardio-card p-8">
            <div className="flex items-center justify-between border-b border-[var(--border-color)] pb-4 mb-6">
              ...
              {/* Progress pill */}
              <div className="w-10 h-10 rounded-full bg-[var(--accent-primary-light)] text-[var(--accent-primary)] flex items-center justify-center font-bold text-xs">
            ...
            {step === 3 && (
              <div className="p-6 border-2 dashed border-[var(--border-color)] rounded-xl flex flex-col items-center text-center">
                <UploadCloud size={32} className="block text-[var(--accent-primary)] mb-2" />
                ...
                <label
                  ...
                  className="btn-secondary mt-4 text-xs py-2 px-4 rounded-full cursor-pointer inline-flex items-center gap-1.5"
                >
                  Choose File
                </label>
    ...
    return (
      <div className="cardio-shell items-center justify-center min-h-screen p-6 text-center">
        <div className="cardio-card max-w-sm w-full p-8 space-y-4">
          <div className="w-16 h-16 rounded-full bg-[var(--accent-primary-light)] text-[var(--accent-primary)] flex items-center justify-center mx-auto animate-pulse">
            <ScanHeart size={36} />
          </div>
