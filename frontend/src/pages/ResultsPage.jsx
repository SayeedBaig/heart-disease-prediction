  ...
  return (
    <div className="cardio-shell">
      ...
      <main className="cardio-container py-8 flex-1 w-full max-w-5xl">
        ...
        <div className="cardio-card p-8 mb-8 text-center rounded-[28px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Link
            to="/patient/reports"
            className="btn-primary py-3.5 px-4 text-xs font-semibold rounded-full text-center flex items-center justify-center gap-2"
          >
            <FileText size={16} />
            View Report
          </Link>
          ...
          <Link
            ...
            className="btn-secondary py-3.5 px-4 text-xs font-semibold rounded-full text-center flex items-center justify-center gap-2"
          >
            <Layers size={16} />
            Digital Twin
          </Link>
