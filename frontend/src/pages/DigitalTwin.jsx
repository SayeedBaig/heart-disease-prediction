      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between pb-6 mb-8 border-b border-[var(--border-color)]">
          <div>
            <div className="flex items-center gap-2">
              <span className="caption-small text-[var(--accent-melanzane)] uppercase tracking-wider font-bold">
          ...
          <div className="flex flex-wrap items-center gap-3 mt-4 md:mt-0">
            ...
            <button
              onClick={handleReset}
              className="btn-secondary text-xs py-2.5 px-3.5 rounded-xl flex items-center gap-1.5"
            >
              <RotateCcw size={15} />
              Reset
            </button>
            ...
            <button
              ...
              className="btn-primary text-xs py-2.5 px-3.5 rounded-xl flex items-center gap-1.5 disabled:opacity-60"
            >
              <FileText size={15} />
            ...
            <button
              ...
              className={`text-xs py-2.5 px-3.5 rounded-xl flex items-center gap-1.5 transition-all ${
                twinEmailSent
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 flex flex-col gap-4">
            <div className="rounded-xl border border-[var(--accent-melanzane-border)] bg-[var(--accent-melanzane-light)] px-4 py-3 text-xs font-semibold text-[var(--accent-melanzane)]">
            ...
            <div className="cardio-card p-0 overflow-hidden">
              ...
              <h3 className="section-title text-[var(--text-primary)] text-sm font-semibold flex items-center gap-2">
                <Scale size={18} className="text-[var(--accent-melanzane)]" />
              ...
              <div className={`space-y-5 px-5 pb-5 ${activeSection !== "vitals" ? "hidden" : ""}`}>
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1.5">
                    ...
                    <span className="text-[var(--accent-melanzane)] font-bold">{params.age} yrs</span>
                  </div>
                  <input
                    type="range"
                    min="18"
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1.5">
                    ...
                    <span className="text-[var(--accent-melanzane)] font-bold">{params.weight} kg</span>
                  </div>
                  <input
                    type="range"
                    min="30"
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1.5">
                    ...
                    <span className="text-[var(--accent-melanzane)] font-bold">{params.bmi} ({bmiCat(params.bmi).label})</span>
                  </div>
                  <input
                    type="range"
                    min="15"
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1.5">
                    ...
                    <span className="text-[var(--accent-melanzane)] font-bold">{params.systolic} mmHg</span>
                  </div>
                  <input
                    type="range"
                    min="80"
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1.5">
                    ...
                    <span className="text-[var(--accent-melanzane)] font-bold">{params.diastolic} mmHg</span>
                  </div>
                  <input
                    type="range"
                    min="50"
              ...
              <div className={`space-y-5 px-5 pb-5 ${activeSection !== "biomarkers" ? "hidden" : ""}`}>
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1.5">
                    ...
                    <span className="text-[var(--accent-melanzane)] font-bold">{params.cholesterol} mg/dL</span>
                  </div>
                  <input
                    type="range"
                    min="100"
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1.5">
                    ...
                    <span className="text-[var(--accent-melanzane)] font-bold">{params.hdl} mg/dL</span>
                  </div>
                  <input
                    type="range"
                    min="20"
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1.5">
                    ...
                    <span className="text-[var(--accent-melanzane)] font-bold">{params.ldl} mg/dL</span>
                  </div>
                  <input
                    type="range"
                    min="40"
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1.5">
                    ...
                    <span className="text-[var(--accent-melanzane)] font-bold">{params.glucose} mg/dL</span>
                  </div>
                  <input
                    type="range"
                    min="70"
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1.5">
                    ...
                    <span className="text-[var(--accent-melanzane)] font-bold">{params.heartRate} bpm</span>
                  </div>
                  <input
                    type="range"
                    min="40"
            ...
            <div className="cardio-card p-0 overflow-hidden">
              ...
              <h3 className="section-title text-[var(--text-primary)] text-sm font-semibold flex items-center gap-2">
                <Flame size={18} className="text-[var(--accent-melanzane)]" />
              ...
              <div className={`space-y-5 px-5 pb-5 ${activeSection !== "lifestyle" ? "hidden" : ""}`}>
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1.5">
                    ...
                    <span className="text-[var(--accent-melanzane)] font-bold">{params.exercise} days / week</span>
                  </div>
                  <input
                    type="range"
                    min="0"
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1.5">
                    ...
                    <span className="text-[var(--accent-melanzane)] font-bold">{params.smoking === "active" || params.smoking === "1" ? "Active" : params.smoking === "former" ? "Former" : "Non-Smoker"}</span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1.5">
                    ...
                    <span className="text-[var(--accent-melanzane)] font-bold">{params.alcohol === "regular" || params.alcohol === "1" ? "Regular" : params.alcohol === "occasional" ? "Occasional" : "None"}</span>
                  </div>
                  <div className="flex gap-3">
                    <button
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1.5">
                    ...
                    <span className="text-[var(--accent-melanzane)] font-bold">{params.medicationAdherence}%</span>
                  </div>
                  <input
                    type="range"
                    min="0"
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-24 self-start space-y-4">
            ...
            <div className="cardio-card p-6 flex flex-col items-center text-center">
              <span className="caption-small uppercase font-bold text-[var(--accent-melanzane)]">
                Live Risk Score
              </span>
            ...
            {summaryVisible && (
              <div className="cardio-card p-6 border-[var(--accent-melanzane-border)] bg-[var(--accent-melanzane-light)]">
                <div className="mb-2 flex items-center gap-2 text-sm font-bold text-[var(--accent-melanzane)]">
        ...
        {showComparison && (
          <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-6">
            <div className="cardio-card max-w-4xl w-full p-6 space-y-4">
              <div className="flex items-center justify-between border-b border-[var(--border-color)] pb-3">
                <h2 className="section-title text-[var(--text-primary)] font-bold">
                  Scenario Comparison
                </h2>
                <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                ...
                <div className="p-4 rounded-xl bg-[var(--accent-melanzane-light)] border border-[var(--accent-melanzane-border)]">
                  <span className="caption-small font-bold text-[var(--accent-melanzane)]">Current Simulation</span>
                  <div className="mt-2 space-y-1 text-[var(--text-primary)] font-semibold">
                    ...
                    <div className="mt-2 pt-2 border-t border-[var(--accent-melanzane-border)] text-sm font-bold text-[var(--accent-melanzane)]">
                      Risk Score: {riskScore}% · Current simulation
                    </div>
                  </div>
                </div>
